...
template_folder = 'C:/monalisa_sos/Templates/Grassland/Templates_newTime/'
...
def Insert_Observation_Grassland(dirs):
    ...
    def write_and_post_xml_ST_SRS(data_folder, template_folder, values, dates, dir, position, sensors, start_index,
        ...
        for x_ST_SRS in range(start_index, end_index):
            ...
            tree.write(
                'C:/monalisa_sos/Insert_observation_xml/Grassland/Insert_Observation_Grassland_ST_' + dir.split('/')[4] +
    ...
    def write_and_post_xml_SWC_SRS(data_folder, template_folder, values, dates, dir, position, sensors, start_index,
        ...
        for x_SWC_SRS in range(start_index, end_index):
            ...
            tree.write(
                'C:/monalisa_sos/Insert_observation_xml/Grassland/Insert_Observation_Grassland_SWC_' + dir.split('/')[4] +
                '.xml', xml_declaration=True, encoding='utf-8', method='xml')
    ...
    def write_and_post_xml_PAR_SRS(data_folder, template_folder, values, dates, dir, position, sensors, start_index,
        ...
        for x_PAR_SRS in range(start_index, end_index):
            ...
            tree.write(
                'C:/monalisa_sos/Insert_observation_xml/Grassland/Insert_Observation_Grassland_PAR_' + dir.split('/')[4] +
                '.xml', xml_declaration=True, encoding='utf-8', method='xml')
    ...
    def write_and_post_xml_NDVI_SRS(data_folder, template_folder, values, dates, dir, position, sensors, start_index,
        ...
        for x_NDVI in range(start_index, end_index):
            ...
            tree.write(
                'C:/monalisa_sos/Insert_observation_xml/Grassland/Insert_Observation_Grassland_NDVI_' + dir.split('/')[4] +
                '.xml', xml_declaration=True, encoding='utf-8', method='xml')
        ...
        for x_PRI in range(start_index, end_index):
            ...
            for element in tags:
                if element.text == '00-00-00T00:00':
                    ...
                    element.text = str(values[x_PRI, 38])
                elif element.text == '7':
            ...
            tree.write(
                'C:/monalisa_sos/Insert_observation_xml/Grassland/Insert_Observation_Grassland_PRI_' + dir.split('/')[4] +
                '.xml', xml_declaration=True, encoding='utf-8', method='xml')
        ...
        for u in range(0, len(files)):
            ...
            with open(file, 'r') as f:
                ...
                if dir.split('/')[4] in standard_srs:
                    write_and_post_xml_ST_SRS(data_folder, template_folder, values, dates, dir, position, sensors, 0, len_values)
                    write_and_post_xml_SWC_SRS(data_folder, template_folder, values, dates, dir, position, sensors, 0, len_values)
                    write_and_post_xml_PAR_SRS(data_folder, template_folder, values, dates, dir, position, sensors, 0, len_values)
                    write_and_post_xml_NDVI_SRS(data_folder, template_folder, values, dates, dir, position, sensors, 0, len_values)
                    write_and_post_xml_PRI_SRS(data_folder, template_folder, values, dates, dir, position, sensors, 0, len_values)
                else:
                    write_and_post_xml_ST_STD(data_folder, template_folder, values, dates, dir, position, sensors, 0, len_values)
                    '''write_and_post_xml_SWC_STD(data_folder, template_folder, values, dates, dir, position, sensors, 0, len_values)
                    write_and_post_xml_PAR_STD(data_folder, template_folder, values, dates, dir, position, sensors, 0, len_values)'''

Insert_Observation_Grassland(dirs)
toc()
